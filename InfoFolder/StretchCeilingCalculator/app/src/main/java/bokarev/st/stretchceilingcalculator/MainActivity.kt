    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        runBlocking {
            ...
            if (listOfTypeCategory.size <= 1) {
                ...
                createTypeOfWorkDataBase(dao) // инициалиировать в БД таблицу с типом работы
                createTypeCategoryDataBase(dao) // инициалиировать в БД таблицу с категориями работы
...
/*
// это покрыть тестами методы
    private fun deleteFromDataBase(dao: TypeCategoryDao) {
    ...
    private fun createTypeCategoryDataBase(dao: TypeCategoryDao) {
        ...
        val typeCategory = listOf(
            ...
            TypeCategory(28, "Обработка углов", "шт.", 500, 4),
    ...
    private fun createTypeOfWorkDataBase(dao: TypeCategoryDao) {
        ...
        Log.d("mytag", "TypeOfWorkDataBase Init")
    }
